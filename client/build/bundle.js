...
/***/ function(module, exports, __webpack_require__) {
	...
	var GuessWho = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(GuessWho, { url: 'api/comments' }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PeopleDisplay = __webpack_require__(160);
	...
	var GuessWho = React.createClass({
	    ...
	    setData: function setData(persons) {
	        var newData = null;
	        if (persons.length > 0) {
	            newData = persons;
	        } else {
	    ...
	    selectRandomPerson: function selectRandomPerson(persons) {
	        if (persons.length > 0) {
	            return parseInt(Math.random() * persons.length);
	        }
	        return null;
	    },
	    getVisiblePeople: function getVisiblePeople() {
	        if (this.state.data) {
	    ...
	    makeGuess: function makeGuess(name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PeopleDisplay = React.createClass({
	    displayName: 'PeopleDisplay',
	
	
	    render: function render() {
	        var people = React.createElement(
	            'h1',
	            null,
	            'Loading...'
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Power = __webpack_require__(163);
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'span',
	                    { className: 'card__text' },
	                    React.createElement('img', { src: 'imgs/card_back.jpg' })
	                )
	            )
	        );
...
/***/ function(module, exports) {
	...
	var Power = {
	    ...
	    addUnderscore: function addUnderscore(input) {
	        if (typeof input === "string") {
	            return input.replace(" ", "_");
	        } else {
	            return input;
	    ...
	    removeProp: function removeProp(object, propertyToRemove) {
	        var newObject = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionMaker = React.createClass({
	    ...
	    generateChars: function generateChars(data) {
	        var characteristics = {};
	        if (data) {
	            var _iteratorNormalCompletion = true;
	            var _didIteratorError = false;
	            ...
	            try {
	                for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    try {
	                        for (var _iterator2 = Object.keys(person)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                            var key = _step2.value;
	        ...
	        try {
	            for (var _iterator3 = Object.keys(characteristics)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                var cs = _step3.value;
	    ...
	    generateSelects: function generateSelects(chars) {
	        ...
	        if (Object.keys(chars).length > 0) {
	            var propOptions = Object.keys(chars).map(function (c) {
	                return React.createElement(
	                    'option',
	                    { key: c, value: c },
	                    Power.removeUnderscore(Power.caps(c))
	                );
	            });
	            propSelector = React.createElement(
	                'select',
	                { key: 'select_properties', onChange: this.handlePropSelect },
	                propOptions
	            );
	            ...
	            var tmp = chars[this.state.selectedProperty].map(function (val) {
	                return React.createElement(
	                    'option',
	                    { key: val, value: val },
	                    Power.caps(val.toString())
	                );
	            });
	
	            valSelector = React.createElement(
	                'select',
	                { key: 'select_values', onChange: this.handleValSelect, value: this.state.selectedValue },
	                tmp
	            );
	            goButton = React.createElement('input', { key: 'select_gobutton', type: 'button', onClick: this.handleAskQuestion, value: 'Ask' });
	        }
